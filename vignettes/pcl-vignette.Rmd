...
![A canopy hit grid that shows the density of VAI aggregated to 1 meter pixels in the canopy.](files/hitgrid.png){width=500px}

![A plant area volume density plot](files/pavd.png){width=500px}

![A plant area volume density plot with histogram](files/pavd_hist.png){width=500px}
