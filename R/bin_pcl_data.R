#' Bin PCL data.
#'
#' \code{bin_pcl} bins and processes PCL data already in the workspace or internally from the
#' the other functions (process_pcl, process_multi_pcl)
#'
#'
#'
#'
...
#'
#' @examples
#' # Where df.pcl is a data frame of pcl data
#' bin_pcl(df.pcl)
#'
...
#'
#' }
bin_pcl <- function(test.data, user_height)
  #########
  # Main scction of script with workflow going from
  ...
  test.2 <- adjust_by_user(test.2, user_height)
